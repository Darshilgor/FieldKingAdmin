        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (contex, index) {
              order?[index]['isOrderDelivered'] == false
                  ? controller.totalNoOfActiveOrder.value++
                  : null;
              return controller.totalNoOfActiveOrder.value == 0
                  ? Center(
                      child: Column(
                  ...
                  : Visibility(
                      visible: order?[index]['isOrderDelivered'] == false,
                      child: Padding(
